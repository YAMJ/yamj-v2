...
//]]>
                    ...
                    <script>
                        ...
                        var movieLocation="<xsl:call-template name="substring-after-last">
                            <xsl:with-param name="string" select="files/file[1]/fileURL" />
                            <xsl:with-param name="delimiter" select="'file:///opt/sybhttpd/localhost.drives/'" />
                        </xsl:call-template>"
...
//]]>
                ...
                <body bgproperties="fixed" background="pictures/background.jpg" onloadset="Play" onload="watched(0);">
                            ...
                            <td height="50" align="center" colspan="2">
                                ...
                                <a>
                                    ...
                                    <xsl:attribute name="href">
                                        <xsl:value-of select="$mjb.homePage" />.html</xsl:attribute>
                                </a>
                                <xsl:if test="$parental-control-on != 'true'">
                                    <a TVID="PGDN">
                                        <xsl:attribute name="href">
                                            <xsl:choose>
                                                <xsl:when
                                                    test="contains(next,'UNKNOWN')">
                                                    <xsl:value-of select="first" />.html</xsl:when>
                                                <xsl:otherwise>
                                                    <xsl:value-of
                                                        select="next" />.html</xsl:otherwise>
                                            </xsl:choose>
                                        </xsl:attribute>
                                    </a>
                                    <a TVID="PGUP">
                                        <xsl:attribute name="href">
                                            <xsl:choose>
                                                <xsl:when
                                                    test="contains(previous,'UNKNOWN')">
                                                    <xsl:value-of select="last" />.html</xsl:when>
                                                <xsl:otherwise>
                                                    <xsl:value-of
                                                        select="previous" />.html</xsl:otherwise>
                                            </xsl:choose>
                                        </xsl:attribute>
                                    </a>
                                </xsl:if>
                        ...
                        <tr align="left" valign="top">
                            ...
                            <td>
                                <table border="0" width="85%">
                                            ...
                                            <xsl:if test="year != 'UNKNOWN'">
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="year/@index != ''">
                                                        <a>
                                                            <xsl:attribute name="href">
                                                                <xsl:value-of select="year/@index" />.html</xsl:attribute>
                                    ...
                                    <tr>
                                        <td class="title2" valign="center">
                                            <xsl:if test="rating != -1">
                                                <xsl:if test="$star_rating = 'true'">
                                                    <img>
                                                        <xsl:attribute name="src">pictures/rating_<xsl:value-of select="round(rating div 10)*10" />.png</xsl:attribute>
                                                    </img>
                                                </xsl:if>
                                                ...
                                                <xsl:when test="people/person[@job='Director']/@name != ''">
                                                    <xsl:choose>
                                                        <xsl:when test="people/person[@job='Director'] != 'UNKNOWN'">
                                                            <a>
                                                                <xsl:attribute name="href">
                                                                    <xsl:if test="$mjb.people.folder!=''">
                                                                        <xsl:value-of select="$mjb.people.folder"/>/</xsl:if>
                                                    ...
                                                    <xsl:if test="director != 'UNKNOWN'">
                                                        <xsl:choose>
                                                            <xsl:when test="director/@index != ''">
                                                                <a>
                                                                    <xsl:attribute name="href">
                                                                        <xsl:value-of select="director/@index" />.html</xsl:attribute>
                                            ...
                                            <xsl:if test="country != 'UNKNOWN'">
                                                ...
                                                <xsl:choose>
                                                    <xsl:when test="country != 'UNKNOWN' and country/@index != ''">
                                                        <a>
                                                            <xsl:attribute name="href">
                                                                <xsl:value-of select="country/@index" />.html</xsl:attribute>
                                                        ...
                                                        <xsl:for-each select="cast/actor[position() &lt;= $actors.max]">
                                                            ...
                                                            <xsl:choose>
                                                                <xsl:when test="@index != ''">
                                                                    <a>
                                                                        <xsl:attribute name="href">
                                                                            <xsl:value-of select="@index" />.html</xsl:attribute>
                                                                        <xsl:value-of select="." />
                                                                    </a>
                                                                </xsl:when>
                                                                <xsl:otherwise>
                                            ...
                                            <center>
                                                <table width="90%">
                                                    <tr>
                                                        ...
                                                        <td class="normal" width="16%">
                                                            <xsl:value-of select="videoSource" />
                                                        </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="normal" width="16%">
                                                            <xsl:value-of select="videoOutput" />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="normal" width="16%" valign="top">
                                                            <xsl:value-of select="audioChannels" />
                                                        </td>
                                                        ...
                                                        <xsl:choose>
                                                            <xsl:when test="libraryDescription != 'UNKNOWN'">
                                                                ...
                                                                <td id="watched" class="normal" width="16%" valign="top">
                                    ...
                                    <xsl:choose>
                                                ...
                                                <tr valign="top">
                                                    ...
                                                    <td align="center" colspan="2">
                                                        ...
                                                        <a class="link">
                                                            ...
                                                            <xsl:attribute name="onclick">watched(2);</xsl:attribute>
                                                            <xsl:if test="@vod">
                                                                <xsl:attribute name="vod">
                                                                    <xsl:value-of select="@vod" />
                                                                </xsl:attribute>
                                                            </xsl:if>
                                                            <xsl:if test="@zcd">
                                                                <xsl:attribute name="zcd">
                                                                    <xsl:value-of select="@zcd" />
                                                                </xsl:attribute>
                                                            </xsl:if>
                                                            <xsl:if test="@rar">
                                                                <xsl:attribute name="rar">
                                                                    <xsl:value-of select="@rar" />
                                                                </xsl:attribute>
                                                            </xsl:if>

                                                            <xsl:if test="//movie/prebuf != -1">
                                                                <xsl:attribute name="prebuf">
                                                                    <xsl:value-of select="//movie/prebuf" />
                                                                </xsl:attribute>
                                                            </xsl:if>
                                        ...
                                        <xsl:when test="//movie/container = 'BDAV' and //movie/season = -1">
                                            <!-- Possible fix for issue 1478, needs format writing to the XML
                                                            ...
                                                            <tr>
                                                                <td class="normal">
                                                                    ...
                                                                    <a class="link">
                                                                        ...
                                                                        <img src="pictures/play_small.png" onfocussrc="pictures/play_selected_small.png" align="top"/>
                                                                        <xsl:text>&#160;</xsl:text>
                                                                        <xsl:value-of select="$skin-playAllText" />
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </xsl:if>
                    ...
                    <script id="watchedjs" language="JavaScript" src="empty.js" type="text/javascript">
                        <xsl:comment>JavaScript</xsl:comment>
                    </script>
                    <a href="#" onclick="watched(1);" TVID="RED">
                        <xsl:comment>Watched Key</xsl:comment>
                    </a>
                </body>
            </html>
        </xsl:for-each>
