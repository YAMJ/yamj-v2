...
public class FilmwebPluginTest extends TestCase {
	...
	public void testGetFilmwebUrlFromGoogle() {
		filmwebPlugin.preferredSearchEngine = "google";
	...
	public void testGetFilmwebUrlFromYahoo() {
		filmwebPlugin.preferredSearchEngine = "yahoo";
	...
	public void testGetFilmwebUrlFromFilmweb() {
		filmwebPlugin.preferredSearchEngine = "filmweb";
	...
	public void testUpdateMediaInfoTitleSort() {
		movie.setId(FilmwebPlugin.FILMWEB_PLUGIN_ID, "http://john.rambo.filmweb.pl");
		filmwebPlugin.setRequestResult("<title>John Rambo / Rambo (2008)  - Film - FILMWEB.pl</title>");
		filmwebPlugin.updateMediaInfo(movie);
		assertEquals("John Rambo", movie.getTitleSort());
	}
	...
	public void testUpdateMediaInfoGenre() {
		...
		filmwebPlugin.updateMediaInfo(movie);
		assertEquals(Arrays.asList(new String[]{"Wojenny"}).toString(), movie.getGenres().toString());
	}
	...
	public void testUpdateMediaInfoCast() {
		...
		filmwebPlugin.updateMediaInfo(movie);
		assertEquals(Arrays.asList(new String[]{"Jerzy Stuhr", "Olgierd Łukaszewicz"}).toString(), Arrays.asList(Arrays.copyOf(movie.getCast().toArray(), 2)).toString());
	}
