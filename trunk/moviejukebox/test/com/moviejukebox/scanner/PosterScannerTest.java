...
public class PosterScannerTest extends TestCase {
    ...
    public void testGetPosterURLFromMovieCovers() throws UnsupportedEncodingException {
        ...
        movieTest.setTitle("CESAR");
        movieTest.setYear("1936");
        expectedURL = baseURL + "CESAR.jpg";
        returnURL = PosterScanner.getPosterURLFromMovieCovers(movieTest);
        assertEquals(expectedURL, returnURL);

        movieTest.setTitle("1001 Pattes");
        movieTest.setYear("1998");
        expectedURL = baseURL + "1001%20PATTES.jpg";
        returnURL = PosterScanner.getPosterURLFromMovieCovers(movieTest);
        assertEquals(expectedURL, returnURL);

        movieTest.setTitle("Ali Baba et les 40 voleurs");
        movieTest.setYear("1954");
        expectedURL = baseURL + "ALI-BABA%20ET%20LES%2040%20VOLEURS.jpg";
        returnURL = PosterScanner.getPosterURLFromMovieCovers(movieTest);
        assertEquals(expectedURL, returnURL);

        movieTest.setTitle("Ali Baba et les 40 voleurs");
        movieTest.setYear("1944");
        expectedURL = baseURL + "ALI%20BABA%20ET%20LES%2040%20VOLEURS%20(1944).jpg";
        returnURL = PosterScanner.getPosterURLFromMovieCovers(movieTest);
        assertEquals(expectedURL, returnURL);

        movieTest.setTitle("Ali Baba et les 40 voleurs");
        movieTest.setYear("2007");
        expectedURL = baseURL + "ALI%20BABA%20ET%20LES%2040%20VOLEURS%20(2007).jpg";
        returnURL = PosterScanner.getPosterURLFromMovieCovers(movieTest);
        assertEquals(expectedURL, returnURL);

        movieTest.setTitle("L'Autre");
        movieTest.setYear("2008");
        expectedURL = baseURL + "L'AUTRE%20(2008).jpg";
        returnURL = PosterScanner.getPosterURLFromMovieCovers(movieTest);
        assertEquals(expectedURL, returnURL);

        movieTest.setTitle("Looking for Eric");
        movieTest.setYear("2009");
