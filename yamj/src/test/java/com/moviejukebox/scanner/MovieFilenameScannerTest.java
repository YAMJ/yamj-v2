...
public class MovieFilenameScannerTest extends AbstractTests {

    private static final Logger LOG = LoggerFactory.getLogger(MovieFilenameScannerTest.class);
