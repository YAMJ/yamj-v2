 ...
 */
public class MovieLogoScanner extends ArtworkScanner {

    private static final Logger logger = Logger.getLogger(MovieLogoScanner.class);

    public MovieLogoScanner() {
        super(ArtworkType.MovieLogo);
    ...
    public boolean isDirtyArtwork(Movie movie) {
        return movie.isDirty(DirtyFlag.CLEARLOGO);
    }
