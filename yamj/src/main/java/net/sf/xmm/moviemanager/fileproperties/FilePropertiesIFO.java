 ...
 * - org.apache.log4j.Logger switched to org.apache.log4j.Logger - Use only
 * getRuntime (Video/Audio/Subs info will be scanned by mediainfo) - removed all
 * unused code - fixed the way duration is computed (minutes and seconds
